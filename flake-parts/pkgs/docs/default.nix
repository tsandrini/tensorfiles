# --- flake-parts/pkgs/docs/default.nix
#
...
let
  READMEs =
    ...
    in
    {
      main = readmeToDerivation (flake-root + "/README.md");
      hosts = {
        "spinorbundle" = readmeToDerivation (flake-root + "/parts/hosts/spinorbundle/README.md");
      };
    };
    ...
    let
      eval = lib.evalModules {
        ...
        specialArgs = rec {
          ...
          inherit flake-root;
          secretsPath = flake-root + "/secrets";
          secretsAttrset = { };
