# --- modules/programs/file-managers/lf.nix
#
...
in {
  options.tensorfiles.programs.file-managers.lf = with types;
        ...
        in {
          ...
          programs.lf = {
            ...
            settings = {
              ifs = _ "\\n";
              filesep = _ "\\n";
              icons = _ userCfg.withIcons;
              ignorecase = _ true;
              drawbox = _ true;
            };
            extraConfig = mkIf userCfg.previewer.enable (mkBefore ''
