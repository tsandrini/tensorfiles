...
[{
  ...
  bookmarks = [
      ...
      bookmarks = [
        ...
        }
        {
          ...
          bookmarks = [
            ...
            }
            {
              ...
              url =
                "http://utf.mff.cuni.cz/vyuka/NTMF059/2021/lectures9187.html";
            }
            {
              name = "NTMF059 - materiály k přednáškám v ZS 2020";
              url =
                "http://utf.mff.cuni.cz/vyuka/NTMF059/2020/prednasky3276.html";
            }
            {
              name = "NTMF059 - materiály k přednáškám v ZS 2020";
              url =
        ...
        }
        {
          ...
          bookmarks = [
            ...
            }
            {
              ...
              url =
                "http://utf.mff.cuni.cz/vyuka/NTMF060/2022/lectures5817.html#prednasky";
            }
            {
              name = "NTMF060 - materiály k přednáškám v LS 2021";
              url =
                "http://utf.mff.cuni.cz/vyuka/NTMF060/2021/prednasky4686.html";
            }
          ];
        }
        {
          ...
          bookmarks = [
            {
              ...
              url =
                "https://www-ucjf.troja.mff.cuni.cz/cejnar/prednasky/qm.html";
            }
            {
        ...
        }
        {
          ...
          bookmarks = [
            ...
            }
            {
              ...
              url =
                "https://www2.karlin.mff.cuni.cz/~smid/pmwiki/pmwiki.php?n=Main.MATproFLS2122";
            }
            {
        ...
        }
        {
          ...
          bookmarks = [
            ...
            {
              name =
                "ufal/npfl114: Materials for the Deep Learning -- ÚFAL course NPFL114";
        ...
        }
        {
          ...
          url =
            "https://www2.karlin.mff.cuni.cz/~malek/new/index.php?title=V%C3%BDuka";
        }
        {
          name =
            "Studijní plány (Karolínka), 2019/2020 – Bc. studium zahájené v roce 2019";
          url =
            "https://www.mff.cuni.cz/cs/studenti/bc-a-mgr-studium/studijni-plany/verze-pro-tisk/studijni-plany-karolinka-2019-2020-bc-studium.pdf";
        }
        {
          name = "Praktikum";
    ...
    # ~ /phil/
    {
      ...
      bookmarks = [{
        name =
          "Lubos Vins. Interpretace vybranych literarnich a filozofickych motivu v dile Franze Kafky.2013.pdf";
        url =
          "https://dspace5.zcu.cz/bitstream/11025/9735/1/Lubos%20Vins.%20Interpretace%20vybranych%20literarnich%20a%20filozofickych%20motivu%20v%20dile%20Franze%20Kafky.2013.pdf";
      }];
    }
    # ~ /compsci/
    {
      ...
      bookmarks = [
        {
          ...
          bookmarks = [
            ...
            {
              name =
                "pyraug/src/pyraug/models/rhvae at main · clementchadebec/pyraug";
              url =
                "https://github.com/clementchadebec/pyraug/blob/main/src/pyraug/models/rhvae/rhvae_model.py";
            }
            {
      ...
      bookmarks = [
        {
          ...
          bookmarks = [{
            name =
              "Latin by the Ranieri-Dowling Method | Latin Grammar, Latin Cases, Latin Declension Chart - YouTube";
        ...
        }
        {
          ...
          bookmarks = [
            {
              name =
                "best way to learn vietnamese and resources? : languagelearning";
              url =
    ...
    # ~ /astro/
    {
      ...
      bookmarks = [
        ...
        }
        {
          ...
          url =
            "https://astrology.com.au/psychic-readings/oracles/animal-spirits/dailyspirit";
        }
      ];
    }
    # ~ /misc/
