...
let
  ...
  '';
in {
  # TODO okay so xmonad can be enabled a buncha ways, the only supported option now
  # is root xinit -> startx -> home-manager xmonad
  # TODO currently the only supported bar is xmobar, I am not even sure how to
