 ...
 */
//static char *font = "SFNS Display:style=Regular:pixelsize=14:antialias=true:autohint=true";
static char *font = "MesloLGM Nerd Font:style=RegularForPowerline:pixelsize=14:antialias=true:autohint=true";
