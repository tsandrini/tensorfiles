        ...
        bookmarks = [
          {
            ...
            bookmarks = [
              ...
              {
                name = "nixos-config/default.nix at master · balsoft/nixos-config · GitHub";
                url = "https://github.com/balsoft/nixos-config/blob/master/profiles/workspace/zsh/default.nix";
              }
            ];
          }
          {
