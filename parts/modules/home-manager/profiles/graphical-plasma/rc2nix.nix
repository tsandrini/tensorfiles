{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "bismuth"."focus_prev_window" = "Meta+J";
      ...
      "bismuth"."move_window_to_next_pos" = "Meta+L";
      "bismuth"."move_window_to_prev_pos" = "Meta+H";
      "bismuth"."move_window_to_right_pos" = [];
      "bismuth"."move_window_to_upper_pos" = [];
      "bismuth"."next_layout" = ["Meta+Backspace" "Meta+Space"];
      "bismuth"."prev_layout" = [];
      ...
      "bismuth"."toggle_stair_layout" = "Meta+F";
      ...
      "org.kde.krunner.desktop"."RunClipboard" = "Meta+Shift+D";
    ...
    configFile = {
      ...
      "kdeglobals"."WM"."activeBackground" = "197,166,112";
      "kdeglobals"."WM"."activeBlend" = "197,166,112";
      "kdeglobals"."WM"."activeForeground" = "170,192,189";
      "kdeglobals"."WM"."frame" = "197,166,112";
      "kdeglobals"."WM"."inactiveBackground" = "118,134,132";
      "kdeglobals"."WM"."inactiveBlend" = "118,134,132";
      "kdeglobals"."WM"."inactiveForeground" = "170,192,189";
      ...
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "file:///home/tsandrini/FiberBundle/Images/Wallpapers/Ultrawide/yosemite.jpg";
